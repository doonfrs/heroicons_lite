...
import 'package:heroicons_lite/src/styles.dart';
...
class HeroIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconPath = path.join('packages/heroicons/assets/$styleName/', icon);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(StringProperty('icon', icon, ifEmpty: '<empty>', showName: false));
